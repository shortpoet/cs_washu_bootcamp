...
# seq = ["1", "11", "1211", "111221"]

# for x in range(len(seq)):
#     seq_lenght = str(len(seq[x]))
...
#             if item[j] == item[j+1]:
#                 this_char_set.append(item[j])
#             else:
#                 print(this_char_set)
#                 this_item_set.append(this_char_set)
#                 this_char_set = []
#             print(this_item_set)
...
for x in range (reps):
    if x == 0:
        total_seq.append(seed)
    if x > 1:
        print(total_seq)
        this_seq = str(total_seq[x-1]).split()
        print(this_seq)
        for i, char in enumerate(this_seq[:-1]):
            if char == this_seq[i+1]:
                this_count += 1
                print(this_count)
            else:
                print(new_seq)
                new_seq += str(this_count) + str(this_seq[i]) 
        total_seq.append(new_seq)
    # count = 1
    # new_seq = []
    # for y in range(len(this_seq)):
    #     if this_seq[y + 1] != None:
    #         if this_seq[y] == this_seq[y+1]:
    #             count += 1
    #     else:
    #         new_seq = str(count) + str(this_seq[y])
    #         count = 1
